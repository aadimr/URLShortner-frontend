        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center w-full sm:w-auto">
                ...
                <div className="w-5/6 sm:w-fit">
                    ...
                    <p className="text-[#6c6d71] sm:w-[28rem] w-full text-center mb-[50px]">Don’t have an account?<Link to="/singUp"><span className="text-[#0236b9] font-medium">SignUp</span></Link> here</p>
                </div>
            </form>
        </div>
    )
