...
function LandingPage() {
    return (
            <div className='xl:px-[12rem] lg:px-[8rem] md:px-[8rem] h-auto px-[5rem] py-10 flex flex-col gap-10'>
                ...
                <div className={"flex gap-4 justify-center"}>
                    <Button name={"SingUp"} className={"border-none w-[7rem] h-[2.5rem] font-medium text-lg bg-[#BA3B0A] text-white"} />
